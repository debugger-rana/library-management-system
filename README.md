...
**Cannot login:**
- Verify credentials: `adm/adm` or `user/user`
...
- Fixed: Use `isAdmin` (boolean) not `isAdmin()` (function)

**"Module not found: getAllMembers":**
- Fixed: Import from correct service (memberService not bookService)

**Dashboard shows 0:**
- Fixed: Extract `response.data` properly from API calls
